...
% arrival date distributions into account and producing Figure 4 from
% the manuscript
...
for strat = strategies
    ...
    xnumlines = ceil(length(vstart_times)/5); % lines every multiple of 60
...
for strat = strategies
    ...
    y=y(:,1);
    %%Divide the lengths by the number of lines needed
    dx = vstart_times(2) - vstart_times(1);
